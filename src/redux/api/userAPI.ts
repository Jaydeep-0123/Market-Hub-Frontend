...
import { AllUsersResponse, DeleteUserRequest, DeleteUserResponse, MessageResponse, UserResponse } from "../../types/api-types";
...
export const userAPI = createApi({
  ...
  deleteUser: builder.mutation<DeleteUserResponse,DeleteUserRequest>({query:({userId,adminUserId})=>({
